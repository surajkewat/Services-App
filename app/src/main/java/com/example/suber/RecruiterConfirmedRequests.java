...
public class RecruiterConfirmedRequests extends AppCompatActivity implements RecruiterRequestsAdapter.OnRequestClickListner  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_recruiter_confirmed_requests);

        txt  = findViewById(R.id.txtNoConfirmedReqRecruiter);
        btn=(Button)findViewById(R.id.btnRecruiterConfirmedShareBooking);

        recyclerView = (RecyclerView) findViewById(R.id.recuiter_confirmed_recyclerview);
    ...
    public void onRequestClick(int position) {
        ...
        editor.commit();
        Intent intent= new Intent(this,SharedToUser.class);
