...
public class RecruiterRequestsAdapter extends RecyclerView.Adapter<RecruiterRequestsAdapter.Holder> {
    Context context;
    ArrayList<RecruiterRequests> data;
    private RecruiterRequestsAdapter.OnRequestClickListner monRequestClickListner;

    public RecruiterRequestsAdapter (ArrayList<RecruiterRequests> data, RecruiterRequestsAdapter.OnRequestClickListner onRequestClickListner)
    {
        this.data = data;
    ...
    RecruiterRequestsAdapter(Context context, ArrayList data){
    ...
    public class Holder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        TextView state;
        ImageView img;
        RecruiterRequestsAdapter.OnRequestClickListner onRequestClickListner;
//        LinearLayout linearLayout;

        public Holder(View v,RecruiterRequestsAdapter.OnRequestClickListner onRequestClickListner) {
            super(v);
...
//            linearLayout = v.findViewById(R.id.linear_layout);
    ...
    public  Holder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new RecruiterRequestsAdapter.Holder(v,monRequestClickListner);
    }

    @Override
    public void onBindViewHolder(@NonNull RecruiterRequestsAdapter.Holder holder, int position) {
