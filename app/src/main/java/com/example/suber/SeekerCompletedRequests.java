...
public class SeekerCompletedRequests extends AppCompatActivity implements RequestsAdapter.OnRequestClickListner {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_seeker_completed_requests);

        btn=(Button)findViewById(R.id.btnSeekerCompleted);
        txt = findViewById(R.id.txtNoCompletedReqSeeker);

        recyclerView = (RecyclerView) findViewById(R.id.seeker_completed_recyclerview);
...
//        SharedPreferences.Editor editor = sharedPreferences.edit();
    ...
    public void onRequestClick(int position) {
        ...
        editor.commit();
        if(uploads.get(position).paymentStatus.equals("0")){
            Intent intent = new Intent(SeekerCompletedRequests.this,PaymentNotDone.class);
            startActivity(intent);
        }
        else{
            Intent intent = new Intent(SeekerCompletedRequests.this,PaymentDOne.class);
            startActivity(intent);
        }
    }
}
